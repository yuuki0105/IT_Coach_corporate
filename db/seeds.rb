...
source_routes = ["Facebookをみて", "Twitterをみて", "noteをみて", "プレスリリースみて", "検索してみて", "口コミ・紹介", "その他"]
...
big_categories = [
  ...
  {big_category: "EC・ネットショップ", categories: ["戦略", "企画", "分析", "売上アップ", "コスト削減", "集客", "CPA改善", "ROI改善", "ディレクション", "内製化・インハウス", "ECサイト構築・制作", "ECサイト運用・運営", "商品ページ制作・編集", "動画制作・編集", "撮影・写真", "画像・サムネイル・バナー", "コピー・ライティング", "決済システム", "キャンペーン", "ブランディング", "CRM", "メルマガ", "ライブコマース", "D2C", "Amazon", "Amazon SEO", "Amazon 広告", "楽天", "楽天 SEO", "楽天 広告", "Yahoo!ショッピング", "Shopify", "BASE", "STORES", "WordPress", "EC-CUBE", "カラーミーショップ", "MakeShop", "Stripe", "Instagram", "Google", "Google スマートショッピングキャンペーン", "その他"]},
