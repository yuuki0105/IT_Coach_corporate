...
Rails.application.configure do
  config.hosts << "www.itcoach.co.jp"
  ...
  # config.active_job.queue_name_prefix = "it_coach_corporate_production"
  ...
  config.action_mailer.default_url_options = { host: 'www.itcoach.co.jp' }
